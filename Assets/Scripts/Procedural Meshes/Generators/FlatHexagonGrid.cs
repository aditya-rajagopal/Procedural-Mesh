...
namespace ProceduralMeshes.Generators
{
    ...
    // We can create a flat hexagon grid by just swapping the X and Z dimensions of the point grid.
    public struct FlatHexagonGrid : IMeshGenerator
    {
        ...
        {
            int vi = 7 * Resolution * x, ti = 6 * Resolution * x;  // each hexagon has 6 triangles and 7 vertices
